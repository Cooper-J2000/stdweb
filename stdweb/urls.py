...
urlpatterns = [
    ...
    path('tasks/<int:id>/template_coverage', views_tasks.task_template_coverage, name='task_template_coverage'),
    path('tasks/<int:id>/update_title', views_tasks.task_update_title, name='task_update_title'),
